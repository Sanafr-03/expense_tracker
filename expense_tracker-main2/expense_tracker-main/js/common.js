...
document.addEventListener('DOMContentLoaded', function() {
    initializeApp();
    updateAllDynamicDates(); // Add this line
});
...
// Add this to common.js (at the end of the file)
function updateAllDynamicDates() {
    // Update current month display on all pages
    ...
    monthElements.forEach(el => {
        el.textContent = currentMonthText;
    });
}
